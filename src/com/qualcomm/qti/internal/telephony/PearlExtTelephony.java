...
public class PearlExtTelephony extends IExtTelephony.Stub {
    ...
    private static PearlExtTelephony sInstance;
    ...
    public static PearlExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new PearlExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private PearlExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
